#In this python file major technical functions will be performed such as generating summary,generating statistics,generating plots,extractions,model training and so forth.
import pandas as pd
import numpy as np
